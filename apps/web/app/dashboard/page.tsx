...
export default function DashboardPage() {
    ...
    return (
        <div className="flex-1">
            {/* ── Top Banner ────────────────────────────────── */}
            <div
                className="bg-brand-primary text-white p-6 md:p-8 rounded-b-[2rem] shadow-lg -mx-4 sm:-mx-6 lg:-mx-8 -mt-6">
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center gap-4">
                            <div
                                className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-md border border-white/10">
                    ...
                    <div
                        className="grid grid-cols-3 gap-4 bg-white/5 p-4 rounded-2xl backdrop-blur-sm border border-white/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {completedToday}/{todaysTasks.length}
                    ...
                    {overdueTasks.length > 0 ? (
                        ...
                        <div
                            className="bg-brand-bg/50 rounded-[1.5rem] shadow-sm border border-brand-bg flex items-center justify-center p-8">
                            <div className="text-center">
                                ...
                                >
                                    <div className="p-5">
                                        <div className="flex items-start justify-between mb-3">
                                            {task.category ? (
                                                <span
                                                    className="bg-primary-50 text-brand-primary text-[10px] uppercase font-bold px-2 py-0.5 rounded">
                          {task.category}
                        </span>
                                            ) : (
                                                <span/>
                                        ...
                                        <div className="mt-4 flex items-center justify-between">
                                            ...
                                            {task.completed ? (
                                                <span
                                                    className="px-2 py-1 rounded-lg text-[10px] font-bold uppercase bg-success-50 text-brand-success">
                          Completed
                        </span>
                                            ) : (
                                                <button
                            ...
                            (You)
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className="bg-brand-bg px-4 py-2 rounded-xl text-center min-w-[80px]">
                                            <div
                                                className="flex items-center justify-center text-brand-primary font-black">
